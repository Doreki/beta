...
//
//    @Test
//     public void 좋아요_누른_게시물_찾아오기() throws Exception{
//        //given
//        List<Long> likesList = new ArrayList<Long>();
//        for (int i = 1; i <= 100; i++) {
//            Member member = createMember("홍길동"+i, "1"+i);
//            memberRepository.save(member);
//
...
//            postsRepository.save(posts);
//
//            likesList.add(posts.getId());
//        }
//
//        Pageable pageable = PageRequest.of(0,10);
//        //when
//        Page<Posts> likedPage = postsRepository.findLikedPosts(likesList,pageable);
//        //then
//        assertThat(likedPage.get().count()).isEqualTo(10);
//    }
//
